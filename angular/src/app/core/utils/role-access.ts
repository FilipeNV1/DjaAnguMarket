...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Sections', link: '/sections', groups: ['CEO', 'Manager', 'Employee'], icon: 'bi-grid-3x3-gap', description: 'Product categories and departments' },
  { label: 'Employees', link: '/employees', groups: ['CEO', 'Manager', 'Employee'], icon: 'bi-people', description: 'View staff across all locations' },
  ...
  { label: 'Distributors', link: '/distributors', groups: ['CEO', 'Manager', 'Employee'], icon: 'bi-truck', description: 'Supplier relationships' },
  ...
  { label: 'Orders', link: '/orders', groups: ['CEO', 'Manager', 'Employee'], icon: 'bi-bag-check', description: 'Orders from distributors' },
];
